<div id="bottombox">
	...
	<div class="leftconditions">
		<ul>
			...
			<?php
			if ($weatherArray[almanacPeriod] == 'Monthly') {
			echo 'Monthly Almanac';
			}
			else {
			echo '30 Day Almanac';
			}
			...
			<dl>
				<dt>Net Moisture</dt>
				<dd style="<?php echo $weatherArray[ETPeriodSumCSS];?>"><?php echo $weatherArray[SQLData][$weatherArray[almanacPeriod]][Value][NetMoisture]; echo $weatherArray[rainUnit];?></dd>
			</dl>
			<dl>
				<dt>------- -------</dt>
				<dd>------- -------</dd>
				<dt>Env. Canada: </dt>
				<dd><a href="http://www.weatheroffice.gc.ca/almanac/almanac_e.html?wqc">Weather Almanacs</a></dd>
			</dl>
			</li>
		</ul> 
	...
	<div>
		<ul>
			...
			<dl>
				...
				<a href="?almanacPeriod=Monthly">Monthly</a>, <a href="?almanacPeriod=Thirty"> past 30 Days</a> or <a href="/NOAA/">NOAA Reports</a> :: 
