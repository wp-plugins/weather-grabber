<div id="bottombox">
	...
	<div class="leftconditions">
		<ul>
			...
			<li>
			<dl>
				<dt>Evapotranspiration <br/><small>Since August 2008</small></dt>
				<dd style="<?php echo $weatherArray[ETPeriodSumCSS];?>"><br/>-<?php echo $weatherArray[SQLData][$weatherArray[almanacPeriod]][Value][ETSum]; echo $weatherArray[rainUnit];?></dd>
			</dl>
			</li>
			<li>
			<dl>
				<dt>Net Moisture <br/><small>Since August 2008</small></dt>
				<dd style="<?php echo $weatherArray[ETPeriodSumCSS];?>"><br/><?php echo $weatherArray[SQLData][$weatherArray[almanacPeriod]][Value][NetMoisture]; echo $weatherArray[rainUnit];?></dd>
			</dl>
			</li>
		</ul> 
	...
	<div>
		<ul>
			...
			<dl>
				...
				<a href="?almanacPeriod=AllTime">All Time (Since November 2005)</a> ::
