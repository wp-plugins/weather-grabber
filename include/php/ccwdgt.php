...
<tr><td colspan="2" class="tg-center"><span title="Temperature" style="' . $weatherArray['outsideTempCSS'] . '">' . $weatherArray['outsideTemp'] . $weatherArray['tempUnit'] . '<br />' . $weatherArray['hourchangetemp'] . '  ' . $weatherArray['tempUnit'] . '/hr</span> </td>';
