...
$output = $output . '<tr class="tg-even"><td colspan="2" class="tg-center"> WindChill<br/>';
...
$output = $output . '<tr>';
$output = $output . '<th colspan="4" class="tg-center">Current and Daily Weather Values</th>';
$output = $output . '</tr>';
...
$output = $output . '<td colspan="1" class="tg-center"><span title="Average Windchill" >Average Windchill<br />' . $weatherArray['intervalAvgWindChill'] . $weatherArray['tempUnit'] . '</span></td>';
$output = $output . '<td colspan="1" class="tg-center"><span title="Average Windspeed" >Average Windspeed<br />' . $weatherArray['intervalAvgWindSpeed'] . ' ' . $weatherArray['windUnit'] . '</span></td>';
$output = $output . '</tr>';
...
$output = $output . '<td colspan="1" class="tg-center" style="' . $weatherArray['hiWindSpeedCSS'] . '"><span title="High Wind Speed" >High Wind<br />' . $weatherArray['hiWindSpeed'] . $weatherArray['windUnit'] . $weatherArray['hiWindSpeedTime'] . '</span></td>';
...
$output = $output . '<tr>';
$output = $output . '<td colspan="1" class="tg-center" style="' . $weatherArray['hiRadiationCSS'] .'"><span title="High Solar Radiation"  >High Solar Radiation<br />' . $weatherArray['hiRadiation'] . $weatherArray['solarUnit'] . $weatherArray['hiRadiationTime'] . '</span></td>';
...
$output = $output . '<td colspan="1" class="tg-center" style="' . $weatherArray['hourrainCSS'] . '"><span title="Rain in Past Hour" >Rain in Past Hour<br />' . $weatherArray['hourrain'] . $weatherArray['rainUnit'] . '</span></td>';
...
$output = $output . '<tr>';
$output = $output . '<td colspan="1" class="tg-center" style="' .'"><span title="Hour Average Temperature"  >Hour Average Temp<br />' . $weatherArray['houravgtemp'] . $weatherArray['tempUnit'] . '</span></td>';
$output = $output . '<td colspan="1" class="tg-center" style="' . '"><span title="Hour Average Wind Speed" >Hour Average Wind Speed<br />' . $weatherArray['houravgwind'] . $weatherArray['windUnit'] .  '</span></td>';
$output = $output . '<td colspan="1" class="tg-center" style="'. '"><span title="Hour Dominant Wind Direction" >Dominant Wind Direction<br />' . $weatherArray['hourdomwinddir'] . '&deg;</span></td>';
$output = $output . '<td colspan="1" class="tg-center"style="' .  '"><span title="Hour Average Humidity" >Hour Average Humidity<br />' . $weatherArray['houravghumid'] . $weatherArray['humUnit'] . '</span></td>';
$output = $output . '</tr>';

$output = $output . '<tr>';
$output = $output . '<td colspan="1" class="tg-center" style="' .'"><span title="Hour Average Dewpoint"  >Hour Average Dewpoint<br />' . $weatherArray['houravgdewpt'] . $weatherArray['tempUnit'] . '</span></td>';
$output = $output . '<td colspan="1" class="tg-center" style="' . $weatherArray['houravgbaromCSS'] .'"><span title="Hour Average Barometer" >Hour Average Barometer<br />' . $weatherArray['houravgbarom'] . $weatherArray['barUnit'] . '</span></td>';
$output = $output . '<td colspan="1" class="tg-center" style="'  . '"><span title="Hour Temperature Change" >Hour Temperature Change<br />' . $weatherArray['hourchangetemp'] . $weatherArray['tempUnit'] .  '</span></td>';
$output = $output . '<td colspan="1" class="tg-center"style="' . '"><span title="Hour Wind Change" >Hour Wind Change<br />' . $weatherArray['hourchangewind'] . $weatherArray['windUnit'] .  '</span></td>';
$output = $output . '</tr>';

$output = $output . '<tr>';
$output = $output . '<td colspan="1" class="tg-center" style="' .'"><span title="Hour Change Wind Direction"  >Hour Change Wind Direction<br />' . $weatherArray['hourchangewinddir'] . '&deg;</span></td>';
$output = $output . '<td colspan="1" class="tg-center" style="' . '"><span title="Hour Change Humidity" >Hour Change Humidity<br />' . $weatherArray['hourchangehumid'] . $weatherArray['tempUnit'] . '</span></td>';
$output = $output . '<td colspan="1" class="tg-center" style="'  . '"><span title="Hour Change Dewpoint" >Hour Change Dewpoint<br />' . $weatherArray['hourchangedewpt'] . $weatherArray['tempUnit'] .  '</span></td>';
$output = $output . '<td colspan="1" class="tg-center"style="' . '"><span title="Hour Barometer Change" >Hour Barometer Change<br />' . $weatherArray['hourchangebarom'] . $weatherArray['barUnit'] .  '</span></td>';
$output = $output . '</tr>';
...
$output = $output . '<tr>';
$output = $output . '<td colspan="1" class="tg-center" style="' . $weatherArray['daywindrunCSS'] .'"><span title="Day Wind Run"  >Day Wind Run<br />' . $weatherArray['daywindrun'] . '&deg;</span></td>';
$output = $output . '<td colspan="1" class="tg-center" style="'  .'"><span title="Day Average Temp" >Day Average Temperature<br />' . $weatherArray['dayavgtemp'] . $weatherArray['tempUnit'] . '</span></td>';
$output = $output . '<td colspan="1" class="tg-center" style="'  . '"><span title="Day Average Wind Speed" >Day Average Wind Speed<br />' . $weatherArray['dayavgwind'] . $weatherArray['windUnit'] .  '</span></td>';
$output = $output . '<td colspan="1" class="tg-center"style="' . '"><span title="Day Dominant Wind Direction" >Day Dominant Wind Direction<br />' . $weatherArray['daydomwinddir'] . '&deg;</span></td>';
$output = $output . '</tr>';

$output = $output . '<tr>';
$output = $output . '<td colspan="1" class="tg-center" style="'  .'"><span title="Day High Wind Direction"  >Day High Wind Direction<br />' . $weatherArray['dayhighwinddir'] . '&deg;</span></td>';
$output = $output . '<td colspan="1" class="tg-center" style="'  .'"><span title="Day Average Humidity " >Day Average Humidity<br />' . $weatherArray['dayavghumid'] . $weatherArray['tempUnit'] . '</span></td>';
$output = $output . '<td colspan="1" class="tg-center" style="'  . '"><span title="Day Average Dewpoint" >Day Average Dewpoint<br />' . $weatherArray['dayavgdewpt'] . $weatherArray['tempUnit'] .  '</span></td>';
$output = $output . '<td colspan="1" class="tg-center"style="' . '"><span title="Day Average Barometer" >Day Average Barometer<br />' . $weatherArray['dayavgbarom'] . $weatherArray['barUnit'] . '</span></td>';
$output = $output . '</tr>';


$output = $output . '<tr>';
$output = $output . '<td colspan="1" class="tg-center" style="'  .'"><span title="Day Change of Temperature"  >Day Change of Temperature<br />' . $weatherArray['daychangetemp'] . $weatherArray['tempUnit'] . '</span></td>';
$output = $output . '<td colspan="1" class="tg-center" style="'  .'"><span title="Day Change of Wind" >Day Change of Wind<br />' . $weatherArray['daychangewind'] . $weatherArray['windUnit'] . '</span></td>';
$output = $output . '<td colspan="1" class="tg-center" style="'  . '"><span title="Day Change Wind Direction" >Day Change Wind Direction<br />' . $weatherArray['daychangewinddir'] .  '&deg;</span></td>';
$output = $output . '<td colspan="1" class="tg-center"style="' . '"><span title="Day Change Humidity" >Day Change Humidity<br />' . $weatherArray['daychangehumid'] . $weatherArray['humUnit'] . '</span></td>';
$output = $output . '</tr>';

$output = $output . '<tr>';
$output = $output . '<td colspan="1" class="tg-center" style="'  .'"><span title="Day Change of Dewpoint"  >Day Change of Dewpoint<br />' . $weatherArray['daychangedewpt'] . $weatherArray['tempUnit'] . '</span></td>';
$output = $output . '<td colspan="1" class="tg-center" style="'  .'"><span title="Day Change of Barometer" >Day Change of Barometer<br />' . $weatherArray['daychangebarom'] . $weatherArray['barUnit'] . '</span></td>';
$output = $output . '<td colspan="1" class="tg-center" style="'  . '"><span title="Day Change Wind Direction" >Day Change Wind Direction<br />' . $weatherArray['daychangewinddir'] .  '&deg;</span></td>';
$output = $output . '<td colspan="1" class="tg-center"style="' . '"><span title="Day Change Humidity" >Day Change Humidity<br />' . $weatherArray['daychangehumid'] . $weatherArray['humUnit'] . '</span></td>';
$output = $output . '</tr>';
